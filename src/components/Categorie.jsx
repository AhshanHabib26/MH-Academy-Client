...
import VideoEdiitng from "../assets/icons/video-editing.png";
  ...
  return (
    <div className={Style.CategorieBannerBg}>
      <div className="px-3 lg:px-14 py-14">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 mx-2 lg:mx-auto max-w-7xl">
          ...
          <div className="flex flex-col items-center justify-center cursor-pointer">
            <div className="border-[1px] border-dashed border-green-300 rounded-full w-[100px] h-[100px] flex items-center justify-center">
              <img className="mx-auto w-[60px]" src={ComputerScience} alt="" />
            </div>
          ...
          <div className="flex flex-col items-center justify-center cursor-pointer">
            <div className="border-[1px] border-dashed border-green-300 rounded-full w-[100px] h-[100px] flex items-center justify-center">
              <img className="mx-auto w-[60px]" src={VideoEdiitng} alt="" />
            </div>
